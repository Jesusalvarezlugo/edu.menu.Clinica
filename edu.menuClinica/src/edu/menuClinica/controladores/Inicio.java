...
public class Inicio {
	...
	public static void main(String[] args) {
		...
		while(!cerrarMenu) {
			...
			case 0:
				System.out.println("[INFO] Se ejecutara el caso 0");
				cerrarMenu=true;
				break;
			case 1:
				System.out.println("[INFO] Se ejecutara el caso 1");
				break;
			case 2:
				System.out.println("[INFO] Se ejecutara el caso 2");
				break;
			case 3:
				System.out.println("[INFO] Se ejecutara el caso 3");
				break;
			case 4:
				System.out.println("[INFO] Se ejecutara el caso 4");
				break;
			case 5:
				System.out.print("[INFO] Se ejecutara el caso 5");
				break;
				default:
					System.out.print("[INFO] Opcion seleccionada Erronea");
					break;
			}
		}
